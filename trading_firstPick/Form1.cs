    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int iNYSE = 0; iNYSE < NYSEsymbol.Count; iNYSE++)
            {
                ...
                try
                {
                    string read_file_name = "\\" + NYSEsymbol[iNYSE] + "_Optimize_Out1.csv";
                    ...
                    //Dictionary<int, double> sortOptPctRtn = optPctRtrn.OrderByDescending(x => x.Value).ToDictionary(pair => pair.Key, pair => pair.Value);

                    #region write max return short day and long day
                    StreamWriter objWriter;
                    string maxoptiOutData = "";
                    string write_file_name = "\\" + NYSEsymbol[iNYSE] + "_MaxOptimize_Out1.csv";
